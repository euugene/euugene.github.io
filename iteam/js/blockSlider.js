'use strict';
    var slider = (function (config) {
      ...
      const ClassName = {
        INDICATOR_ACTIVE: 'slide__indicator_active',
        ITEM: 'slide__item',
        ITEM_LEFT: 'slide__item_left',
        ITEM_RIGHT: 'slide__item_right',
        ITEM_PREV: 'slide__item_prev',
        ITEM_NEXT: 'slide__item_next',
        ITEM_ACTIVE: 'slide__item_active'
      }
      ...
      var
        ...
        _actionClick = function (e) {
          ...
          if (!(e.target.hasAttribute('data-slide-to') || e.target.classList.contains('slide__control'))) {
          ...
          if (e.target.hasAttribute('data-slide-to')) {// осуществляем переход на указанный сдайд 
            ...
            e.preventDefault();
            _slideTo(e.target.classList.contains('slide__control_next') ? 'next' : 'prev');
          }
        },
